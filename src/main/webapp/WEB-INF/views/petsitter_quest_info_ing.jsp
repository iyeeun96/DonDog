...
<div class="wrap">
	...
	<jsp:include page="header.jsp"/>
		...
		<div class="chkinfo_res">
			...
			<form id ="succes" name="frmSubmit" action="./resing_end" class="petsitter_res"
			method="post" enctype="multipart/form-data"
			onSubmit="return boxcheak(this)">
			<input type="hidden" name="pst_num" value="${respet.rsp_num}">
			
			<div class="btn-area">
					<input class="btn-write_res sub_succes" type="submit" value="수락하기 ">
					<input class="btn-write_res sub_succes2" type="button" value="수정하기"
						onclick="location.href='./petsitterupdate?pnum=${respet.rsp_num}'">
					<input class="btn-write_res sub_succes" type="button" value="거절하기 "
						onclick="cancle()">
