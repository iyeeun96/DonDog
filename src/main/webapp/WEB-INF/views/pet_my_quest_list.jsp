		...
		<div class="petquestlist-form">
			...
			<div class="data-area">
				<div class="title-row">
					...
					<div class="t-title p-20">의뢰번호</div>
					<div class="t-title p-20">예약번호</div>
				...
				<div class="data-row">
					...
					<div class="t-title p-20">
						<a href="myquest?mnum=${qitem.mp_num}">
						${qitem.mp_num}</a></div>
					<div class="t-title p-20">${qitem.rsp_num}</div>
					<div class="t-title p-15">${qitem.m_id2}</div>
					<div class="t-title p-15"><c:set var= "level" value="${qitem.mp_etc}"/>
