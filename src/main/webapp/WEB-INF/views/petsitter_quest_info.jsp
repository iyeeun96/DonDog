...
<div class="wrap">
	...
	<jsp:include page="header.jsp"/>
		...
		<div class="chkinfo_res">
			...
			<form id="respris" action="./petsittersucces" class="petsitter_res"
			method="post" enctype="multipart/form-data"
			onSubmit="return boxcheak(this)">
      		<div class="petsitter_ing2">
      		<input type="hidden" name="pst_num" value="${respet.rsp_num}">
      		<input type="hidden" name="pst_id" value="${mb.m_id}">
      		<h3>금액결정</h3>
      		<input class="write-input_petres_cash" type="text" name="pst_cash"><span class="cash">원</span>
			</div>
		
			<div class="btn-area">
				<input class="btn-write_res sub_succes" type="submit" value="의뢰수락">
