					...
					<div class="data-area">
						<div class="title-row">
							...
							<div class="data-row">
								...
								<div class="p-10">${c.m_id}</div>
							</div>	
					</div>
					<button id="cashSuc" style="color:green; float: right;">결제승인</button>
				</div>
			</div>
		</section>
...
<script type="text/javascript">
	$("#cashSuc").on('click', function() {
		var con = confirm("결제 승인하시겠습니까?");
		if (con) {
			location.replace('./cashSuccess?c_num=${c.c_num}');
		}
	});
</script>
</html>