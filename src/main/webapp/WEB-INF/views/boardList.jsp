...
<div class="wrap">
	...
	<div class="content">
		<div class="board-form">
			...
			<label><input type="button" value="head" onclick="prompt_test()"/>말머리별</label> 
...
function prompt_test() {
	var inputString = prompt('말머리를 입력하세요', '0 ~ 4 숫자만'); 
	location.href="headBoard?head=" + inputString + "&pageNum=1";
}
</script>
