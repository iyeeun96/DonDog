		...
		<section>
			<div class="content">
					...
					<div class="servicebox">
						...
						업체 번호 : <input type="text" name="s_cnum" id="s_cnum" VALUE="${bh_num}">
						<input type="button" value="등록" onclick="serviceInsert()">
					</div>
				...
				<form action="./serviceContents">
					<div class="btn-area">
						<input type="hidden" name="bh_num" value="${bh_num}">
