...
<div class="wrap">
	...
	<section>
	<div class="content">
		<form action="./boardHostWrite" class="write-form"
			...
			<h2 class="login-header">업체 정보 등록</h2>
			...
			<input type="text" class="hbwrite-input"
				name="bh_title" autofocus placeholder="제목"
				required>
				...
				<input type="file" name="files2" id="file2" multiple>
				<input class="upload-name2" value="파일선택2"
					readonly>
				<input type="hidden" id="filecheck2" value="0"
					name="fileCheck2">
				</div>
			<textarea rows="6" name="bh_contents"
				placeholder="내용을 적어주세요..."
				class="write-input ta"></textarea>
			<div class="filebox">
				<label for="file3">업로드</label>
				<input type="file" name="files3" id="file3" multiple>
				<input class="upload-name3" value="파일선택3"
					readonly>
				<input type="hidden" id="filecheck3" value="0"
					name="fileCheck3">
			</div>
			<div class="btn-area">
