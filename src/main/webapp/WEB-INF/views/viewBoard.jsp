...
<div class="wrap">
	...
	<div class="content">
		<div class="board-form">
			...
			<h2 class="login-header">조회수순 게시글 목록</h2>
			<label><input type="button" value="head" />말머리별</label> 
			<label><input type="button" value="time" onclick="location.href='./boardList'"/>업체 등록순</label>
			<div class="data-area">
				<div class="title-row">
