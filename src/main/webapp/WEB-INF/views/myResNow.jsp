	...
	<div class="content">
		<div class="board-form">
			...
			<div class="data-area">
				...
				<div class="data-row">
					<div class="t-no p-15"><a href="./myResHosContents?hp_num=${hitem.hp_num}">${hitem.hp_num}</a></div>
					<div class="t-title p-15">${hitem.h_id}</div>
					<div class="t-name p-15">${hitem.hp_in}</div>
					<div class="t-date p-15">${hitem.hp_out}</div>
					<div class="t-view p-15"><c:set var= "level" value="${hitem.hp_suc}"/>
			...
			<div class="data-area">
				<div class="title-row">
					<div class="t-no p-15">접수번호</div>
					<div class="t-title p-15">펫시터아이디</div>
					<div class="t-name p-15">체크인</div>
					<div class="t-date p-15">체크아웃</div>
					<div class="t-view p-15">수락여부</div> 
				</div>
				...
				<div class="data-row">
					...
					<div class="t-title p-15">${pitem.m_id2}</div>
			...
			<div class="data-area">
				...
				<div class="data-row">
					...
					<div class="t-no p-15"><a href="./myResBeaContents?ca_num=${citem.ca_num}">${citem.ca_num}</a>
					</div>
			...
			<div class="data-area">
				...
				<c:set var="ca" value="${citem.ca_num}"></c:set>
					...
					<div class="t-no p-15"><a href="./myResTraContents?ca_num=${citem.ca_num}">${citem.ca_num}</a></div>
					<div class="t-title p-15">${citem.h_id}</div>
					<div class="t-name p-15">${citem.ca_in}</div>
					<div class="t-date p-15">${citem.ca_out}</div>
			...
			<div class="data-area">
				...
				<c:if test="${fn:contains(ca,'H')}">
					<div class="t-no p-15"><a href="./myResHotContents?ca_num=${citem.ca_num}">${citem.ca_num}</a></div>
					<div class="t-title p-15">${citem.h_id}</div>
					<div class="t-name p-15">${citem.ca_in}</div>
					<div class="t-date p-15">${citem.ca_out}</div>
			...
			<div class="btn-area">
				<button class="wr-btn" onclick="location.href='./myMain'">뒤로 가기</button>
			</div>
	</div>
