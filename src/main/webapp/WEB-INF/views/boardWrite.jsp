...
<body>
	<div class="wrap">
		...
		<section>
			<div class="content">
				<form action="./writeBoard" class="write-form" method="post"
						enctype="multipart/form-data">
						<h2 class="login-header">게시판 글쓰기</h2>
						...
						<input type="text" class="write-input" name="b_head" autofocus placeholder="말머리 : 0 ~ 4 입력" required>
